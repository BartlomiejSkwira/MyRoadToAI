...
-----|-------------|------
[DataWorkshop 5 day challenge](http://dataworkshop.eu/challenge) |Very basics of Python, Anaconda, Jupyter, Google Cloud, Scikit-learn. The result was a basic model which predicted bus delays in Krakow.  | [Certificate](https://github.com/BartlomiejSkwira/MyRoadToAI/blob/master/dataworkshop%20challenge%20certyfikat.pdf)
